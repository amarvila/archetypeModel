...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public Page<CustomerDto> getAllCustomers(final Pageable pageable) throws SalesException {
    ...
    public CustomerDto createCustomer(final CustomerDto customerDto) throws SalesException {
        ...
        final CustomerEntity customerEntity = customerRepository.save(customerEntityMapper.mapToEntity(customerDto));
